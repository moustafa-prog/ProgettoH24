...
public class RicevimentiOrtopedico extends JFrame {
    ...
    public RicevimentiOrtopedico(String tipoUtente) {
    ...
    private void deleteSelectedRows(ActionEvent e) {
        ...
        if (selectedRow != -1) {
            ...
            try {
            	controller.deleteRicevimento(codiceFiscale);
    ...
    private void saveLastRow(ActionEvent e) {
		...
		Ricevimenti ricevimento = new Ricevimenti(cognome, nome, data, ora, codiceFiscale, "ORTOPEDICO" );
        try {
        
        	controller.addRicevimento(ricevimento);
    ...
    private void loadDataFromDatabase() {
        try {
            List<Ricevimenti> ricevimenti = controller.getAllRicevimenti();
    ...
    public static void main(String[] args) {
		...
		RicevimentiOrtopedico frame = new RicevimentiOrtopedico(tipoUtente);
